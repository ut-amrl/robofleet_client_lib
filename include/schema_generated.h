...
#ifndef FLATBUFFERS_GENERATED_SCHEMA_FB_DETECTION_MSGS_H_
#define FLATBUFFERS_GENERATED_SCHEMA_FB_DETECTION_MSGS_H_
...
inline DetectedItemT *DetectedItem::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<fb::detection_msgs::DetectedItemT> _o = std::unique_ptr<fb::detection_msgs::DetectedItemT>(new DetectedItemT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
#endif  // FLATBUFFERS_GENERATED_SCHEMA_FB_DETECTION_MSGS_H_
